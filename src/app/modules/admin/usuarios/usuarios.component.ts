...
export class UsuariosComponent implements OnInit {
  ...
  paginaActual = 0; tamanioPagina = 10; totalElementos = 0; totalPaginas = 0;
  ...
  cambiarTamanio(tamanio: number): void { this.tamanioPagina = tamanio; this.paginaActual = 0; this.cargarUsuarios(); }
